...
def main():
    ...
    document = agent.run("Write me a document on polymers in food-packaging. Please make sure that you have a table listing all the most common polymers and their properties, a section on biodegradability and common practices to improve strenght and durability.")
